<?php
/*
 * Model used for custom application configuration management via the database
 */
class Config_model extends MY_Model {
    public function __construct() {
        // Override our table/id/name settings
        $this->setAll(array('table' => 'config', 'id' => 'name', 'name' => 'value'));
    }

    // Function go get all configuration options
    public function getOptions() {
        return $this->getRows(array(), null, array('name', 'ASC'));
    }
