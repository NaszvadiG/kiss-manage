    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
               <b>Manage Billables</b>
            </div>
            <div class="panel-body">
                <div class="well" style="padding-bottom: 3px;">
                    <h4>{{ selected.id ? 'Update' : 'Add' }} Billable</h4>
                    <form role="form" id="edit_form" method="POST" action="/business/setBillable">
                            ...
                            <table class="table" id="checks-edit-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="text" name="post_array[description]" placeholder="Description" value="{{ selected.description }}" data-validation="required" data-validation-error-msg="Description required">
                                        </td>
                                        <td style="width: 200px;">
                                            <select class="form-control" name="post_array[client_id]">
                                        ...
                                        <td style="width: 100px;">
                                            <input class="form-control" type="text" name="post_array[amount]" placeholder="0.00" value="{{ selected.amount }}" data-validation="required" data-validation-error-msg="Amount required">
                                        </td>
                                    <tr>
                                    <tr>
                ...
                <div class="row">
                <div class="col-md-4">
                <form role="form" id="filter_date_form" method="POST" action="/business/billables">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="data_row_table">
                        ...
                        <tr>
                            <td style="vertical-align: middle; text-align: right; width: 30px;">
                                <a class="btn btn-primary btn-circle fa fa-pencil" href="/business/billables/{{ row.id }}"></a>&nbsp;
                            ...
                            <td style="vertical-align: middle; width: 200px;" class="row_category">{{ row.client }}</td>
                            <td style="vertical-align: middle;">{{ row.invoice_id }}</td>
                ...
                <form id="delete_row_form" method="POST" action="/business/deleteBillable">
...
$(document).ready(function() {
    ...
    $(".delete_row").click(function(){
        ...
        var check = "Are you sure you want to delete this billable: " + row_date + " - " + row_desc;
