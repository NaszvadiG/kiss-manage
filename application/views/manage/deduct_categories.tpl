    ...
    <div class="col-md-6">
        <div class="panel panel-primary">
            <div class="panel-heading">
               <b>Manage Deductible Categories</b>
            </div>
            <div class="panel-body">
                <form role="form" id="manage_form" method="POST" action="/manage/setDedCategories">
                        ...
                        <table class="table" id="manage-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control delete_row_entry" type="text" name="data[{{ id }}]" value="{{ row.name }}" data-validation="required" data-validation-error-msg="You must provide a category name">
                                    </td>
                                </tr>
                                {% endfor %}
                                <tr>
                                    <td>&nbsp</td>
                                    <td>
                                        <input class="form-control new_rows" type="text" name="data_new[]" value="" placeholder="Add new category">
                                    </td>
                                </tr>
                                <tr>
                ...
                <form id="delete_form" method="POST" action="/manage/deleteDedCategory">
...
$(document).ready(function() {
    ...
    $("#manage-table").on("change keyup paste", ".new_rows", function (event){
        ...
        if(status) {
            $('#manage-table tr:last').before('<tr><td>&nbsp;</td><td><input class="form-control new_rows" type="text" name="data_new[]" value="" placeholder="Add new category"></td></tr>');
        }
    });
