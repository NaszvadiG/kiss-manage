    ...
    <div class="col-md-6">
        <div class="panel panel-primary">
            <div class="panel-heading">
               <b>Manage Tax Categories</b>
            </div>
            <div class="panel-body">
                <form role="form" id="manage_form" method="POST" action="/manage/setTaxCategories">
                ...
                <form id="delete_form" method="POST" action="/manage/deleteTaxCategory">
